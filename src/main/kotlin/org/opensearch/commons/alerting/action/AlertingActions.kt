...
object AlertingActions {
    ...
    const val RUN_WORKFLOW_ACTION_NAME = "cluster:admin/opendistro/alerting/workflow/run"
    ...
    @JvmField
    val RUN_WORKFLOW_ACTION_TYPE =
        ActionType(RUN_WORKFLOW_ACTION_NAME, ::RunWorkflowResponse)
}
